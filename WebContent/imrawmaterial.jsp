<%@ page language="java" import="java.sql.*"%><%@ page import="beans.*" %>
<HTML>
...
int s1=Integer.parseInt(request.getParameter("broken"));
int s2=Integer.parseInt(request.getParameter("unbroken"));
	  ...
	  int i=ps.executeUpdate();
                  ...
                  if(i!=0)
                    {          
                      ...
                      %>
                    <jsp:forward page="imrecord.html"/>
					<%
                    }
				ps.close();
				con.close();
